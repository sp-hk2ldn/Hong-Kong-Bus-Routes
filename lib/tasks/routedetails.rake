namespace :businfo do
  ...
  task :details => :environment do
    ...
    @routes.each do |route|
      url = "http://mobileapp.nwstbus.com.hk/text/getstopinroute.php?r=" + route.routenumber.gsub(/\s+/, "") + "&d=" + route.direction + "&v=" + route.special + "&company=" + route.company + "&from=routesearch&l=1"
